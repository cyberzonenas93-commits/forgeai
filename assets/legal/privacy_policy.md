...
- To provide and operate the app (auth, repository sync, AI suggestions, commits, pull requests, CI checks, wallet and token accounting).
- To send you push notifications you opt into (e.g., checks, Git activity, wallet alerts).
- To improve the app, diagnose errors, and enforce usage limits and security.
...
- You can **delete your account** at any time from within the app (Settings → Account actions → Delete account). Account deletion removes your Firebase Authentication identity and, in line with our backend processes, we delete or anonymize your app-held data (e.g., profile, wallet, repository links, activity, and related records). Some data may remain in backups for a limited period before being purged.
- If you use Guest access and later create a full account or delete the app, the same deletion and retention principles apply where applicable.

## Security

We use industry-standard practices (including HTTPS and secure authentication) to protect your data. No method of transmission or storage is 100% secure; we cannot guarantee absolute security.
...
We may update this policy from time to time. We will notify you of material changes by posting the updated policy in the app or by other appropriate means. Continued use of the app after changes constitutes acceptance of the updated policy.
